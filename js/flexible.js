...
function(e, t) {
	...
	if (n.setAttribute("data-dpr", s), !o) if (o = r.createElement("meta"), o.setAttribute("name", "viewport"), e.webPageScalable ? o.setAttribute("content", "initial-scale=" + m + ", user-scalable=yes") : o.setAttribute("content", "initial-scale=" + m + ", maximum-scale=" + m + ", minimum-scale=" + m + ", user-scalable=no viewport-fit=cover"), n.firstElementChild) n.firstElementChild.appendChild(o);
	else {
	...
	!1),
	"complete" === r.readyState ? (r.body.style.fontSize = 12 * s + "px",r.body.classList.add('flexible')): r.addEventListener("DOMContentLoaded",
	function(e) {
		r.body.style.fontSize = 12 * s + "px",r.body.classList.add('flexible')
	},
	!1),
	i(),
	d.dpr = e.dpr = s,
